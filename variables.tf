...
variable "vault_transit_private_ip_dr" {
  description = "The private ip of the first Vault node for Auto Unsealing"
  default     = "10.0.101.31"
}
...
variable "vault_server_private_ips_dr" {
  ...
  # @see https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html
  type    = list(string)
  default = ["10.0.101.32", "10.0.101.33", "10.0.101.34"]
}


# URL for Vault Ent binary
variable "vault_zip_file" {
  default = "https://releases.hashicorp.com/vault/1.13.1+ent.hsm/vault_1.13.1+ent.hsm_linux_amd64.zip"
}
